...
$("#"+c.fileInputID).attr("disabled",!1),b.clearStorage(d.fileKey);else $("#"+c.fileInputID).attr("disabled",!1),e.status?(b.clearStorage(d.fileKey),c.onError({errCode:k.errCode,errMsg:k.errMsg})):console.log("\u4e0a\u4f20\u5df2\u6682\u505c")}};h="?offset="+d.offset+"&complete="+(d.trunkEnd>=d.file.size)+"&context="+(m||d.context)+"&version="+b.version;e.open("post",a.serveIp+"/"+a.bucketName+"/"+encodeURIComponent(a.objectName)+h);e.setRequestHeader("x-nos-token",a.token);e.send(l.call(d.file,d.offset,
